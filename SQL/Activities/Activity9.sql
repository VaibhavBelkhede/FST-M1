...
SELECT salesman_name,customer_name,city,commission FROM customers INNER JOIN salesman ON customers.salesman_id = salesman.salesman_id;

SELECT customer_name,grade,salesman_name FROM customers LEFT JOIN salesman ON customers.salesman_id = salesman.salesman_id WHERE grade<300 ORDER BY customer_id;
